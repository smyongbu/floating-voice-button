...
class MainActivity : Activity(), RecognitionController.Listener {
    ...
    override fun onCreate(state: android.os.Bundle?) {
        super.onCreate(state); setContentView(R.layout.activity_main);applySystemInsets(findViewById(R.id.mainRoot));setupBottomNavigation(NAV_RECOGNITION); RecognitionController.init(this)
        ...
        recordButton.setOnClickListener{ensureAudio{RecognitionController.toggle()}};overlayButton.setOnClickListener{toggleOverlay()};findViewById<Button>(R.id.copyButton).setOnClickListener{copyText(transcriptText.text.toString())};showDevicePerformance();updateOverlay()
    }
